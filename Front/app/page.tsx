...
function Discover() {
  return (
    <div className={homeCss.section}>
  <div className="flex flex-col w-full justify-content items-center p-3 max-[720px]:ml-30 ">
    ...
    <div className={`${homeCss.scrollbar}  mt-30 h-[450px]  `}>
  ...
  return (
    ...
    <div className="flex flex-col items-center p-3 max-[720px]:ml-30 max-[720px]:mt-10 ">
      ...
      <div className="flex gap-4 max-[720px]:flex-col mt-10" >
        <div className={`flex justify-center items-center p-7 flex-col max-w-[500px] h-[700px] border border-green-700/30 rounded-4xl bg-emerald-800 hover:-translate-y-4 duration-500 cursor-pointer ${homeCss.cardh} relative`}>
