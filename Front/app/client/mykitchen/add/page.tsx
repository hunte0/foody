...
function Add() {
  ...
  const Ingredient_name = useRef<HTMLInputElement>(null);
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-[#FAF6F1] flex flex-col items-center pt-10 px-4 mt-20 text-black">
            ...
            <div className="mb-6 ">
              <div>
                <label className="block text-lg text-gray-700 mb-1 font-bold ">Recipe Name</label>
                 <input type="text" placeholder="Enter recipe name" className="w-full p-3 border-2 border-slate-300 rounded-lg outline-none text-black" ref={recipe_name} />
              </div>
            </div>
            ...
            <div className="flex gap-4 mb-6">
              <div className="flex-1">
                ...
                <select className="w-full p-3 border-2 border-slate-300 rounded-lg outline-none text-sm text-black" ref={category} >
                  ...
                  <option value="healthy" >Breakfast</option>
              ...
              <div className="flex-1">
                <Input label="Cooking Time" phtext="Enter cooking time" />
              </div>
            </div>
        ...
        <div className="mb-6">
          ...
          >
            ...
            <div className="mb-6">
              ...
              <textarea placeholder="Describe the cooking steps..."
            ...
            <button className="mt-3 bg-amber-700 hover:bg-amber-900 text-white font-semibold px-4 py-2 rounded-lg transition-colors">
              Save Recipe
            </button>
          </div>
        </div>
